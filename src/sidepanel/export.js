...
function evidenceImageHTML(result, label) {
  ...
  return `<section class="page evidence-page state-evidence">
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .page { width: 100%; min-height: 9.65in; position: relative; padding-bottom: 0.35in; break-after: page; page-break-after: always; }
    ...
    .state-evidence { margin: 0; padding: 0 0 0.35in; break-inside: avoid; page-break-inside: avoid; }
    ...
    .state-evidence img { display: block; width: auto; height: auto; max-width: 100%; max-height: 8.5in; margin: 0 auto; border: 1px solid #cbd5e1; border-radius: 4px; }
